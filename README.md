...
This repository provides tools to download and decrypt WhatsApp media files (`.enc`) directly from the Android `msgstore.db` database.

## 🌟 Why this project?
Many legacy extractors depend on libraries like `curve25519` (Curve Donna), which often face critical compilation errors in modern Python 3 and Termux environments.
